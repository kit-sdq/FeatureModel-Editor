 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.featuremodel.impl.SimulatorComponentImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimulatorComponentImpl extends MinimalEObjectImpl.Container implements SimulatorComponent {
	...
	protected EClass eStaticClass() {
		return FeaturemodelPackage.Literals.SIMULATOR_COMPONENT;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.SIMULATOR_COMPONENT__PATH,
					oldPath, path));
	}
