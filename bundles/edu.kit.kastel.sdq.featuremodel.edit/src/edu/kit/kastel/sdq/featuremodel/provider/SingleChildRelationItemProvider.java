...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.featuremodel.SingleChildRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SingleChildRelationItemProvider extends ChildRelationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SingleChildRelationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addChildPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_SingleChildRelation_child_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SingleChildRelation_child_feature",
						"_UI_SingleChildRelation_type"),
				FeaturemodelPackage.Literals.SINGLE_CHILD_RELATION__CHILD, true, false, true, null, null, null));
	}
